...
window = Tk()
window.title("National Public School - Signup")
window.geometry("1920x1820")
window.config(bg="#5b595c")  # background colour

# Top Heading Frame
TopHeadingFrame = Frame(window, bg="#08452b")
TopHeadingFrame.pack(side=TOP, fill=X)

# Top Heading Label
TopHeadingLabel = Label(TopHeadingFrame, text="Welcome To National Public School",
                        font=("arial", 30, "bold"), fg="white", bg="#08452b")
TopHeadingLabel.pack(padx=10, pady=10, anchor="center")

# MidFrame Background Frame
mid_frame = Frame(window, bg='#0f1791')
mid_frame.pack(side=TOP, padx=10, pady=10)

# Signup Label
signupLabel = Label(mid_frame, text="Signup", font=("arial", 26, "bold"),
                    fg="blue", bg="white")
...
# Email Label
emailLabel = Label(mid_frame, text="Email", font=("arial", 16), fg="white", bg="black")
...
confirmPasswordLabel = Label(mid_frame, text="Confirm Password", font=("arial", 16), fg="white", bg="black")
...
show_password_checkbox = Checkbutton(mid_frame, text="Show Password", variable=show_password_var,
                                     onvalue=1, offvalue=0, bg='#0f1791', fg="white",
...
AlreadyUserLabel = Label(mid_frame, text='I have an account?',
                         font=('arial', 10), fg='#726f73', bg='#0f1791')
